...
import { Box, Container, Typography, Card, alpha } from '@mui/material';
      ...
      <Box sx={{ pt: 12, bgcolor: '#FAFAFA', minHeight: '100vh' }}>
        ...
        <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 } }}>
          ...
          <Grid container spacing={8} alignItems="center" sx={{ mb: 15 }}>
            ...
            <Grid item xs={12} md={6}>
              <Card elevation={0} sx={{ p: 4, bgcolor: 'white', border: '1px solid', borderColor: 'rgba(0, 0, 0, 0.08)', borderRadius: 3, boxShadow: '0 4px 12px rgba(0, 0, 0, 0.05)' }}>
          ...
          {/* Founder */}
          <Card elevation={0} sx={{ p: { xs: 4, md: 6 }, mb: 15, bgcolor: 'white', border: '1px solid', borderColor: 'rgba(0, 0, 0, 0.08)', borderRadius: 3, boxShadow: '0 4px 12px rgba(0, 0, 0, 0.05)' }}>
            <Box>
              <Typography variant="h3" fontWeight={900} sx={{ mb: 1 }}>
                Founder
              </Typography>
              <Typography variant="h4" fontWeight={900} sx={{ color: '#1a1a1a', mb: 2 }}>
                Radhakrishnan N
              </Typography>
              <Typography variant="h6" sx={{ color: '#666', fontStyle: 'italic', mb: 4 }}>
                "Passion of Sports"
              </Typography>
              <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.8 }}>
          ...
          {/* Team */}
          <Box sx={{ mb: 15 }}>
            <Typography variant="h3" fontWeight={900} textAlign="center" sx={{ mb: 6, color: '#1a1a1a' }}>
              TEAM
            </Typography>
            <Grid container spacing={4}>
              {team.map((person) => (
                <Grid item xs={12} md={4} key={person.name}>
                  <Card elevation={0} sx={{ p: 4, textAlign: 'center', bgcolor: 'white', border: '1px solid', borderColor: 'rgba(0, 0, 0, 0.08)', borderRadius: 3, boxShadow: '0 4px 12px rgba(0, 0, 0, 0.05)', '&:hover': { borderColor: '#1a1a1a', transform: 'translateY(-8px)', boxShadow: '0 12px 24px rgba(0, 0, 0, 0.08)' }, transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }}>
          ...
          <Grid container spacing={6} sx={{ mb: 15 }}>
            <Grid item xs={12} md={6}>
              <Card elevation={0} sx={{ p: 5, height: '100%', bgcolor: 'white', border: '1px solid', borderColor: 'rgba(0, 0, 0, 0.08)', borderRadius: 3, boxShadow: '0 4px 12px rgba(0, 0, 0, 0.05)', '&:hover': { borderColor: '#1a1a1a', boxShadow: '0 12px 24px rgba(0, 0, 0, 0.08)', '& .icon-box': { transform: 'scale(1.1)', bgcolor: '#1a1a1a', color: 'white' } }, transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }}>
                <Box className="icon-box" sx={{ width: 64, height: 64, borderRadius: 2, display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: alpha('#1a1a1a', 0.05), color: '#1a1a1a', mb: 4, transition: 'all 0.3s ease' }}>
          ...
          <Grid container spacing={4}>
            {values.map((value, index) => (
              <Grid item xs={12} sm={6} md={3} key={index}>
                <Card elevation={0} sx={{ p: 4, height: '100%', textAlign: 'center', bgcolor: 'white', border: '1px solid', borderColor: 'rgba(0, 0, 0, 0.08)', borderRadius: 3, boxShadow: '0 4px 12px rgba(0, 0, 0, 0.05)', '&:hover': { borderColor: '#1a1a1a', transform: 'translateY(-8px)', boxShadow: '0 12px 24px rgba(0, 0, 0, 0.08)', '& .value-icon': { color: '#1a1a1a', transform: 'scale(1.1)' } }, transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }}>
                  <Box className="value-icon" sx={{ color: 'text.secondary', mb: 2, transition: 'all 0.3s ease' }}>
                    {value.icon}
                  </Box>
